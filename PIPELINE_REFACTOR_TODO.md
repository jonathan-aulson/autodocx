...
## 5. Validation
- [ ] Run `autodocx scan ./repos/bw-samples-master --out out --llm-rollup` after refactors to verify ordering, doc richness, and diagram quality.
- [ ] Spot-check curated docs + SVGs to confirm the LLM minimum word floor, new flow coverage, and final repo rollup quality.
