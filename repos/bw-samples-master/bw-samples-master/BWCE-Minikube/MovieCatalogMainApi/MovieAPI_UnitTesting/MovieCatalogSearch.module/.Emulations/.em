...
<emulation:EmulationData xmlns:emulation="http:///emulation.ecore" isBW="true" location="MovieCatalogSearch.module">
  ...
  <ProcessNode Id="moviecatalogsearch.module.SortSingleMovie" Name="moviecatalogsearch.module.SortSingleMovie" ModelType="BW" moduleName="MovieCatalogSearch.module">
    <Operation Name="callProcess" serviceName="moviecatalogsearch.module.SortSingleMovie">
      <Inputs Id="b6fcb3e6-aadb-4534-ac10-d150d54c7ae4MovieCatalogSearch.module_moviecatalogsearch.module.SortSingleMovie_callProcess_Start" Name="Start" isDefault="true" type="CALLPROCESS">
        <informations Name="input" nameSpace="http://www.example.org/MovieCatalogMaster">
          <nameSpaces prefix="tns" nameSapce="http://www.example.org/MovieCatalogMaster"/>
          <Parameter Name="tns:MovieInfo">
            <parameters Name="tns:Title" type="string" nameSpace="http://www.w3.org/2001/XMLSchema" canDelete="true"/>
            <parameters Name="tns:Year" type="string" nameSpace="http://www.w3.org/2001/XMLSchema" canDelete="true"/>
            <parameters Name="tns:imdbID" type="string" nameSpace="http://www.w3.org/2001/XMLSchema" canDelete="true"/>
            <parameters Name="tns:Type" type="string" nameSpace="http://www.w3.org/2001/XMLSchema" canDelete="true"/>
            <parameters Name="tns:Poster" type="string" nameSpace="http://www.w3.org/2001/XMLSchema" canDelete="true"/>
          </Parameter>
        </informations>
      </Inputs>
    </Operation>
