...
import { pnlViewMultiSitesYearStress } from "@/scenarios/stress/scenario-11-pnl-view-multisites-year"; // Adjust path as needed
...
export const options: Options = {
  ...
  thresholds: {
    ...
    pnl_multi_sites_load_time: ["p(95)<3000"],
    pnl_multi_sites_load_success: ["rate>0.98"],
...
export function setup(): void {
  console.log("🏗️ P&L View with Multiple Sites (Year) Stress Test Starting");
...
export function teardown(): void {
  console.log("✅ P&L View with Multiple Sites (Year) Stress Test Completed");
}
