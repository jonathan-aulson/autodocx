...
import { payrollEditSaveStress } from "@/scenarios/stress/scenario-5-payroll-edit-save"; // Adjust path as needed
...
export const options: Options = {
  ...
  thresholds: {
    ...
    payroll_edit_get_time: ["p(95)<3000"],
    payroll_edit_patch_time: ["p(95)<3000"],
    step_success_rate: ["rate>0.95"],
    payroll_edit_get_success: ["rate>0.98"],
    payroll_edit_patch_success: ["rate>0.98"],
  },
};

// --- K6 setup: runs once per test (before VUs start) ---
export function setup(): void {
  console.log("🏗️ Payroll Edit Save Stress Test Starting");
...
export function teardown(): void {
  console.log("✅ Payroll Edit Save Stress Test Completed");
}
