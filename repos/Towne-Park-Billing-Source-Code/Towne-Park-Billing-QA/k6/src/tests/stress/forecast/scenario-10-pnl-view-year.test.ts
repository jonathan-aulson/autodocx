...
import { pnlViewYearStress } from "@/scenarios/stress/scenario-10-pnl-view-year"; // Adjust path as needed
...
export const options: Options = {
  ...
  thresholds: {
    ...
    pnl_load_time: ["p(95)<3000"],
    pnl_load_success: ["rate>0.98"],
...
export function setup(): void {
  console.log("🏗️ P&L View (Year) Stress Test Starting");
...
export function teardown(): void {
  console.log("✅ P&L View (Year) Stress Test Completed");
}
