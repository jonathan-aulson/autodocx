...
import { statisticsEditSaveStress } from "@/scenarios/stress/scenario-4-statistics-edit-save"; // Adjust path as needed
...
export const options: Options = {
  ...
  thresholds: {
    ...
    edit_statistics_get_time: ["p(95)<3000"],
    edit_statistics_patch_time: ["p(95)<3000"],
    step_success_rate: ["rate>0.95"],
    statistics_load_success: ["rate>0.98"],
    edit_statistics_get_success: ["rate>0.98"],
    edit_statistics_patch_success: ["rate>0.98"],
  },
};

// --- K6 setup: runs once per test (before VUs start) ---
export function setup(): void {
  console.log("🏗️ Statistics Edit Save Stress Test Starting");
...
export function teardown(): void {
  console.log("✅ Statistics Edit Save Stress Test Completed");
}
