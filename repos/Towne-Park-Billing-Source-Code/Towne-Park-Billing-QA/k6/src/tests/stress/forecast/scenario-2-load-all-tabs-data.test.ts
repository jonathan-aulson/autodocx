...
import { loadAllTabsData } from "@/scenarios/stress/scenario-2-load-all-tabs-data"; // Adjust path as needed
...
export const options: Options = {
  ...
  thresholds: {
    ...
    // Test-specific thresholds for all tabs scenario
...
export function setup(): void {
  console.log("🏗️ Load All Tabs Data Stress Test Starting");
...
export function teardown(): void {
  console.log("✅ Load All Tabs Data Stress Test Completed");
}
