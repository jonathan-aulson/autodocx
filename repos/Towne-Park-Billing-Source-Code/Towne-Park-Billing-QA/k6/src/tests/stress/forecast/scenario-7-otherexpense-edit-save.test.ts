...
import { otherExpenseEditSaveStress } from "@/scenarios/stress/scenario-7-otherexpense-edit-save"; // Adjust path as needed
...
export const options: Options = {
  ...
  thresholds: {
    ...
    edit_other_expense_get_time: ["p(95)<3000"],
    edit_other_expense_patch_time: ["p(95)<3000"],
    step_success_rate: ["rate>0.95"],
    edit_other_expense_get_success: ["rate>0.98"],
    edit_other_expense_patch_success: ["rate>0.98"],
  },
};

// --- K6 setup: runs once per test (before VUs start) ---
export function setup(): void {
  console.log("🏗️ Other Expense Edit Save Stress Test Starting");
...
export function teardown(): void {
  console.log("✅ Other Expense Edit Save Stress Test Completed");
}
